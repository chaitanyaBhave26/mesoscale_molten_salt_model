...
[Materials]
  [constants]
    ...
    prop_values = '1.5     10                   5.1e-5                        %int_width%           1.1131e-11 '
                  ' 3.141592653 ${fparse 0.025 * 2 / %int_width% } 6.02214076e23 0.0 5e-4 0.8 0.01'
  []
  [energy_constants]
    type = GenericConstantMaterial
...
#     num_points = ${fparse 160 / %int_width% }
#     sort_by = id
#   [../]
#   [./perp_gb]
#     type = LineValueSampler
...
#     num_points = ${fparse 30 / %int_width% }
#     sort_by = id
#   [../]
# []
[Executioner]
