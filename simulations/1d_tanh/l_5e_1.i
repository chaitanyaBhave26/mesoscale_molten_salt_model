...
[GlobalParams]
  ...
  l_by_h = 8
  file_base_str = '0_5um/0_5um_l_by_h_'
[]
...
[Materials]
  ...
  [constants]
    ...
    prop_values = '1.5     6.803e6          1.493e7                   0.5                    1.1131e-11  3.141592653  0.1       6.02214076e23   0.0 5e-4'
  []
  [energy_constants]
    type = GenericConstantMaterial
...
[Outputs]
  ...
  perf_graph = true
  csv = true
  file_base = ${raw ${GlobalParams/file_base_str} ${GlobalParams/l_by_h} }
[]
