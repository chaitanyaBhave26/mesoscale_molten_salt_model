...
[Transfers]
  [to_sub]
    ...
    source_variable = 'gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9 eta1'
    variable = 'gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9 eta1'
    multi_app = sub
  []
[]
[GlobalParams]
...
[Materials]
  [constants]
    ...
    prop_names = 'gamma    gr_energy_sigma  interface_energy_sigma    interface_thickness_l  Va pi '
                 'del_int'
    prop_values = '1.5     6.803                  14.29                        1.0        '
  ...
  [switch_melt]
    ...
    h_name = h_melt
    all_etas = 'eta1 gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9'
    phase_etas = 'eta1'
  []
  [switch_metal]
    type = SwitchingFunctionMultiPhaseMaterial
  ...
  [chi_Ni]
    type = DerivativeParsedMaterial
    f_name = 'chi_Ni'
    args = 'w_Ni eta1 gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9'
