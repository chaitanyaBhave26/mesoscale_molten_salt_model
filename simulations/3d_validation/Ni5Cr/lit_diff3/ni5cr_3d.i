...
[ICs]
  ...
  [c_global_inital]
    ...
    outside = -0.45065 #Same Ni2+ as Ni-5Cr
  []
  [c_Cr_global_inital]
    type = BoundingBoxIC
    variable = 'w_Cr'
...
[Materials]
  [constants]
    ...
    prop_values = '1.5     6.803e6          1.429e7                    1.0                     '
                  '1.1131e-11  3.141592653 0.05       6.02214076e23 0.0 5e-04 0.8 0.01'
    outputs = 'nemesis'
  []
  [energy_constants]
    type = GenericConstantMaterial
  ...
  [switch_melt]
    ...
    f_name = 'h_melt'
    args = 'eta1 gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9'
  ...
  [h_gb]
    type = ParsedMaterial
    args = 'gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9 bnds'
    f_name = 'h_gb'
  ...
  [del_c_Ni]
    type = DerivativeParsedMaterial
    f_name = 'del_c_Ni'
    args = 'w_Ni w_Cr gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9' # gr8 gr9 gr10 gr11 eta1 '
  ...
  [del_c_Cr]
    type = DerivativeParsedMaterial
    f_name = 'del_c_Cr'
    args = 'w_Ni w_Cr gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9'
  ...
  [omega_metal]
    type = DerivativeParsedMaterial
    f_name = 'omega_metal'
    args = 'gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9 eta1 w_Ni w_Cr'
  ...
  [M_e]
    type = DerivativeParsedMaterial
    args = 'gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9 eta1 w_Ni w_Cr phi'
    f_name = 'M_e'
  ...
  [flux_Cr]
    type = DerivativeParsedMaterial
    args = 'gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9 eta1 w_Cr phi'
    f_name = 'chem_flux_Cr'
