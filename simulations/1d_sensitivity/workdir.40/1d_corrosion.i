...
[Materials]
  ...
  [constants]
    ...
    prop_values = '1.5     6.803e6          14930000                  1.8        1.1131e-11  3.141592653  0.025   6.02214076e23   0.0 5e-4'
  []
  [energy_constants]
    type = GenericConstantMaterial
  ...
  [D_Ni]
    ...
    function = '0.000152*h_metal  + 500*(1-h_metal) '
    outputs = 'exodus'
  []
  ...
  [D_Cr]
    ...
    function = '4.53e-05*(c_Va/2.254e-7)*h_metal  + 500*(1-h_metal) '
    outputs = 'exodus'
  []
  [mobility_Cr]
    type = DerivativeParsedMaterial
