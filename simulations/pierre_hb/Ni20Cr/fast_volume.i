...
[Materials]
  ...
  [D_Cr_V]
    ...
    function = '7.8862*(exp(-(84702800778885824000*xc + '
  ...
  [D_Cr_GB]
    ...
    function = '7.8862*(exp((209787039506469*xc)/17179869184)*exp(2393065153853383/140737488355328)*exp(-(85'
