...
[UserObjects]
  [eta_init]
    ...
    mesh = 'ebsd_reader/ebsd_reader.e'
    system_variables = 'eta1 gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9 gr10 gr11'
    timestep = 'LATEST'
  []
[]
[Functions]
...
[Materials]
  [constants]
    ...
    prop_values = '1.5     6.803e6          1.429e7                    2.0                     '
                  '1.1087e-11  3.141592653 0.025     6.02214076e23 0.0 5e-04'
    outputs = 'nemesis'
  []
  [energy_constants]
    type = GenericConstantMaterial
    prop_names = 'kB            R      T     n  F          e        k_metal  k_melt   HF_H2  E0_F   '
                 'E_F' #E0_F is electrode potential in Baes, E_F is pontential in the experimental salt
    prop_values = '8.6173324e-5 8.314  973  2  96485.33212 1.6e-19  1.0     1.0      1e-9   2.871  '
                  '3.3607'
    outputs = 'nemesis'
  []
  ...
  [switch_melt]
    ...
    f_name = 'h_melt'
    args = 'eta1 gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9 gr10 gr11'
  ...
  [h_gb]
    type = ParsedMaterial
    args = 'gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9 gr10 gr11 bnds'
    f_name = 'h_gb'
    function = "16*(gr0^2*gr1^2 +gr0^2*gr2^2 +gr0^2*gr3^2 +gr0^2*gr4^2 +gr0^2*gr5^2 +gr0^2*gr6^2 "
               "+gr0^2*gr7^2 +gr0^2*gr8^2 +gr0^2*gr9^2 +gr0^2*gr10^2 +gr0^2*gr11^2 +gr1^2*gr2^2 "
               "+gr1^2*gr3^2 +gr1^2*gr4^2 +gr1^2*gr5^2 +gr1^2*gr6^2 +gr1^2*gr7^2 +gr1^2*gr8^2 "
               "+gr1^2*gr9^2 +gr1^2*gr10^2 +gr1^2*gr11^2 +gr2^2*gr3^2 +gr2^2*gr4^2 +gr2^2*gr5^2 "
               "+gr2^2*gr6^2 +gr2^2*gr7^2 +gr2^2*gr8^2 +gr2^2*gr9^2 +gr2^2*gr10^2 +gr2^2*gr11^2 "
               "+gr3^2*gr4^2 +gr3^2*gr5^2 +gr3^2*gr6^2 +gr3^2*gr7^2 +gr3^2*gr8^2 +gr3^2*gr9^2 "
               "+gr3^2*gr10^2 +gr3^2*gr11^2 +gr4^2*gr5^2 +gr4^2*gr6^2 +gr4^2*gr7^2 +gr4^2*gr8^2 "
               "+gr4^2*gr9^2 +gr4^2*gr10^2 +gr4^2*gr11^2 +gr5^2*gr6^2 +gr5^2*gr7^2 +gr5^2*gr8^2 "
               "+gr5^2*gr9^2 +gr5^2*gr10^2 +gr5^2*gr11^2 +gr6^2*gr7^2 +gr6^2*gr8^2 +gr6^2*gr9^2 "
               "+gr6^2*gr10^2 +gr6^2*gr11^2 +gr7^2*gr8^2 +gr7^2*gr9^2 +gr7^2*gr10^2 +gr7^2*gr11^2 "
               "+gr8^2*gr9^2 +gr8^2*gr10^2 +gr8^2*gr11^2 +gr9^2*gr10^2 +gr9^2*gr11^2 +gr10^2*gr11^2 "
               ")"
    outputs = nemesis
  ...
  [omega_metal]
    type = DerivativeParsedMaterial
    f_name = 'omega_metal'
    args = 'gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9 gr10 gr11 eta1 w_Ni w_Cr'
  ...
  [M_e]
    type = DerivativeParsedMaterial
    args = 'w_Ni gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9 gr10 gr11 eta1 '
    f_name = 'M_e'
  ...
  [flux_Ni]
    type = DerivativeParsedMaterial
    args = 'gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9 gr10 gr11 eta1  w_Ni phi'
    f_name = 'chem_flux_Ni'
  ...
  [flux_Cr]
    type = DerivativeParsedMaterial
    args = 'gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9 gr10 gr11 eta1 w_Cr phi'
    f_name = 'chem_flux_Cr'
  ...
  [elec_M_Ni]
    type = DerivativeParsedMaterial
    f_name = 'elec_M_Ni'
    args = 'w_Ni gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9 gr10 gr11 eta1  phi'
  ...
  [elec_M_Cr]
    type = DerivativeParsedMaterial
    f_name = 'elec_M_Cr'
    args = 'w_Cr gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9 gr10 gr11 eta1  phi'
...
[Outputs]
  ...
  csv = true
  perf_graph = true
  file_base = 'ni20_cr_corr/ni20_cr_corr'
[]
