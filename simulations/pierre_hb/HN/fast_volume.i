...
[Materials]
  [constants]
    ...
    prop_values = '1.5     6.803e6          1.429e7                    0.5                     1.0895e-11  3.141592653 0.1       6.02214076e23 6e-4 5e-04 0.8 0.01'
    outputs = 'nemesis'
  []
  [energy_constants]
    type = GenericConstantMaterial
  ...
  [D_Cr_V]
    ...
    function = '37.0109*(exp(-(84702800778885824000*xc + '
  ...
  [D_Cr_GB]
    ...
    function = '37.0109*(exp((209787039506469*xc)/17179869184)*exp(2393065153853383/140737488355328)*exp(-(85'
