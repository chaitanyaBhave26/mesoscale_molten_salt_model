[Mesh]
  type = GeneratedMesh
  dim = 1
  nx = ${fparse xmax /   ${GlobalParams/int_width} }
  xmax = 160
  ny = 1
  ymax = 2
  uniform_refine = 3
...
[ICs]
  ...
  [w_Cr]
    ...
    radius = 150
    invalue = -0.6416  #HN
    outvalue = -0.9699 #Cr2+ concentration is 25e-6
  []
[]
...
[Materials]
  ...
  [constants]
    ...
    prop_values = '1.5     6.803e6          1.493e7                   ${GlobalParams/int_width}  1.10895e-11  3.141592653  ${fparse 0.05 / ${GlobalParams/int_width}}   6.02214076e23     6e-4 5e-4'
    outputs = exodus
  []
  [energy_constants]
    type = GenericConstantMaterial
