...
[Materials]
  ...
  [constants]
    ...
    prop_values = '1.5     6.803e6          1.493e7                   2.0                    1.10895e-11  3.141592653  0.025     6.02214076e23     6e-4 5e-4'
  []
  [energy_constants]
    type = GenericConstantMaterial
  ...
  [D_Cr]
    ...
    function = '( D_Cr_V*h_metal  + 500*(1-h_metal) )'
    outputs = 'exodus'
  []
  [mobility_Cr]
    type = DerivativeParsedMaterial
