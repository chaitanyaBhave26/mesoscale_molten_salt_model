[Mesh]
  [gen]
    ...
    nx = 160 ##2000 #40 #200
    xmin = -1e-5
    xmax = 159.649 ##999.99999
    ny = 100 ##25 ##50 ##3000 #12
    ymin = -1e-5
    ymax = 99.99999 ##24.99999 #100
    # elem_type = QUAD4
  []
...
[Materials]
  [constants]
    ...
    prop_values = '1.5     10                   5.1e-5                          0.50         1.1087e-11 '
                  ' 3.141592653 0.1 6.02214076e23 1.675e-04 5e-04 0.8 0.01'
    outputs = 'nemesis'
  []
  [energy_constants]
    type = GenericConstantMaterial
  ...
  [h_gb]
    type = ParsedMaterial
    args = 'gr0 gr1 gr2 gr3 gr4 gr5 gr6 gr7 gr8 gr9 gr10 gr11 bnds' # gr12 gr13 gr14 bnds'
    f_name = 'h_gb'
  ...
  [D_Cr_V]
    ...
    # function = 'exp(D0*xc + D1)*exp(-(E0*xc+E1)/R/T)'#'*(c_Va/2.254e-7)'
  ...
  [D_Cr_GB]
    ...
    # function = 'exp(D0*xc + D1)*exp(-(E0*xc+E1)/R/T)*(c_Va/2.254e-7)/GB_width'
...
[Outputs]
  ...
  csv = true
  perf_graph = true
  file_base = 'ni20cr_mean_minus_sd/ni20cr_mean_minus_sd'
[]
