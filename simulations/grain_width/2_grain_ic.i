[Mesh]
  type = GeneratedMesh
  dim = 2
  nx = ${fparse ${xmax} * 4 / ${GlobalParams/int_width} } #250
  xmax = 10
  ny = ${fparse ${ymax} * 4 / ${GlobalParams/int_width} }#200
  ymax = 5
  # uniform_refine = 3
[]
...
[Materials]
  ...
  #                'del_int'
  #   prop_values = '1.5     6.803                  14.429                        ${GlobalParams/int_width}         '
  ...
  [m]
    type = ParsedMaterial
    f_name = mu
    material_property_names = 'interface_energy_sigma gr_energy_sigma interface_thickness_l'
  ...
  #   f_name = mu
  #   material_property_names = 'interface_energy_sigma gr_energy_sigma interface_thickness_l'
  #   function = '6*gr_energy_sigma/interface_thickness_l'
  # []
  #SWITCHING FUNCTIONS
  [switch_melt]
...
[Outputs]
  ...
  [exodus]
    ...
    interval = 20
  []
  file_base = 'two_grain_ic/two_grain_ic'
  perf_graph = true
  csv = true
[]
