...
[ICs]
  ...
  [c_global_inital]
    ...
    x2 = 300
    y2 = 520
    inside = -0.4667   #Ni-20Cr
    outside = -0.45065 #Same Ni potential as in Ni-5Cr
  []
  [c_Cr_global_inital]
    type = BoundingBoxIC
    variable = 'w_Cr'
...
[BCs]
  ...
  [w_Ni_right]
    type = DirichletBC
    variable = w_Ni
    value = -0.45065 #Same Ni potential as in Ni-5Cr
    boundary = 'right'
  []
  [w_Cr_right]
    type = FunctionDirichletBC
    variable = w_Cr
    function = '-0.9699' #Cr2+ concentration is 25e-6
    boundary = 'right'
...
[Materials]
  [constants]
    ...
    prop_names = 'gamma    gr_energy_sigma  interface_energy_sigma    interface_thickness_l   Va     '
                 '     pi           del_int   Na            xc  GB_width b l'
    prop_values = '1.5     6.803e6          1.429e7                    0.5                     '
                  '1.1131e-11  3.141592653 0.1       6.02214076e23 0.0 5e-04 0.8 0.01'
    outputs = 'nemesis'
  []
  [energy_constants]
    type = GenericConstantMaterial
